...
export const DIAMOND_BUILDINGS: DiamondBuilding[] = [
  {
    ...
    emoji: '💠',
    desc: 'Кристалічний жар пече стабільно та гаряче (+2% CPS)',
    baseCost: 10,
    baseCps: 150,
    percentBonus: 0.02,
    requireRebirth: 0,
  },
  {
    ...
    emoji: '⛏️',
    desc: 'Добуває алмазний пил для надміцного тіста (+3% CPS)',
    baseCost: 25,
    baseCps: 1000,
    percentBonus: 0.03,
    requireRebirth: 0,
  },
  {
    ...
    emoji: '🏛️',
    desc: 'Королівська резиденція елітних пекарів (+4% CPS)',
    baseCost: 50,
    baseCps: 6000,
    percentBonus: 0.04,
    requireRebirth: 1,
  },
  {
    ...
    emoji: '🔬',
    desc: 'Синтез нано-фокач вищої проби (+5% CPS)',
    baseCost: 100,
    baseCps: 45000,
    percentBonus: 0.05,
    requireRebirth: 2,
  },
  {
    ...
    emoji: '🗿',
    desc: 'Древня статуя бога випічки (+6% CPS)',
    baseCost: 200,
    baseCps: 250000,
    percentBonus: 0.06,
    requireRebirth: 3,
  },
  {
    ...
    emoji: '🌌',
    desc: 'Генерує фокачі з зоряного пилу (+8% CPS)',
    baseCost: 350,
    baseCps: 1000000,
    percentBonus: 0.08,
    requireRebirth: 4,
