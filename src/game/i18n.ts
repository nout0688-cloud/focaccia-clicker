...
export const TRANSLATIONS = {
  uk: {
    ...
    tips: [
      ...
      '• 🔄 Ребіртх доступний від 1 000 000 фокач (1 млн / 1кк) — дає +7% доходу назавжди та відкриває нові товари!',
  ...
  ru: {
    ...
    tips: [
      ...
      '• 🔄 Ребиртх доступен от 1 000 000 фокачч (1 млн / 1кк) — даёт +7% дохода навсегда и открывает новые товары!',
