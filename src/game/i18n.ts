...
export const TRANSLATIONS = {
  uk: {
    ...
    gameVersion: 'ФОКАЧА КЛІКЕР v1.3.2',
    ...
    donateSubtitle: 'Офіційна покупка за Telegram Stars ⭐ або картки 🇺🇦',
    donateMethodStars: '🌟 Telegram Stars',
    donateMethodCard: '💳 Картка України (₴)',
    donateUah: '₴',
    donateCardHint: 'Оплата будь-якою карткою України або через Apple Pay / Google Pay. Алмази нарахуються автоматично!',
    donateCheckBtn: '🔄 Перевірити оплату',
    donateChecking: 'Перевіряємо надходження…',
    donateNotFound: 'Оплату ще не знайдено. Якщо вже оплатили, зачекайте кілька секунд і натисніть знову.',
    donateSuccess: 'Оплату підтверджено! Алмази зараховано!',
  ...
  ru: {
    ...
    gameVersion: 'ФОКАЧЧА КЛИКЕР v1.3.2',
    ...
    donateSubtitle: 'Официальная покупка за Telegram Stars ⭐ или карты 🇺🇦',
    donateMethodStars: '🌟 Telegram Stars',
    donateMethodCard: '💳 Карта Украины (₴)',
    donateUah: '₴',
    donateCardHint: 'Оплата любой картой Украины или через Apple Pay / Google Pay. Алмазы начислятся автоматически!',
    donateCheckBtn: '🔄 Проверить оплату',
    donateChecking: 'Проверяем поступление…',
    donateNotFound: 'Оплата пока не найдена. Если уже оплатили, подождите пару секунд и нажмите снова.',
    donateSuccess: 'Оплата подтверждена! Алмазы начислены!',
