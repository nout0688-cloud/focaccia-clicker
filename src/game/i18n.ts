...
export const BUILDINGS_I18N: Record<string, Record<Lang, LocalizedItem>> = {
  ...
  train: {
    uk: { name: 'Фокача-експрес', desc: 'Швидкісна доставка гарячої випічки містами' },
    ru: { name: 'Фокачча-экспресс', desc: 'Скоростная доставка горячей выпечки по городам' },
  },
  rocket: {
  ...
  station: {
    uk: { name: 'Орбітальна станція', desc: 'Лабораторія невагомого випікання на орбіті' },
    ru: { name: 'Орбитальная станция', desc: 'Лаборатория выпечки в невесомости на орбите' },
  },
  portal: {
  ...
  dyson: {
    uk: { name: 'Сфера Дайсона', desc: 'Мегаструктура, що збирає енергію сонця для печей' },
    ru: { name: 'Сфера Дайсона', desc: 'Мегаструктура, собирающая энергию солнца для печей' },
  },
  quantum: {
    uk: { name: 'Квантовий синтезатор', desc: 'Синтезує досконалі фокачі прямо з вакууму' },
    ru: { name: 'Квантовый синтезатор', desc: 'Синтезирует совершенные фокаччи прямо из вакуума' },
  },
  bigbang: {
    uk: { name: 'Первинне полум’я', desc: 'Космічне тепло, що зародило всі аромати буття' },
    ru: { name: 'Первичное пламя', desc: 'Космическое тепло, зародившее все ароматы бытия' },
  },
  infinity: {
    uk: { name: 'Вічний очаг', desc: 'Незгасне священне полум’я нескінченної випічки' },
    ru: { name: 'Вечный очаг', desc: 'Неугасимое священное пламя бесконечной выпечки' },
  },
};
...
export const VIP_UPGRADES_I18N: Record<string, Record<Lang, LocalizedItem>> = {
  ...
  vip_frenzy: {
    uk: { name: 'Гіпер-френзі', desc: 'Френзі триває 20с (замість 15с) та дає x7 замість x6' },
    ru: { name: 'Гипер-френзи', desc: 'Френзи длится 20с (вместо 15с) и даёт x7 вместо x6' },
  },
  vip_polish: {
...
export const ACHIEVEMENTS_I18N: Record<string, Record<Lang, LocalizedItem>> = {
  ...
  a21: {
    uk: { name: 'Залізничник', desc: 'Запусти фокача-експрес' },
    ru: { name: 'Железнодорожник', desc: 'Запусти фокачча-экспресс' },
  },
  a22: {
    uk: { name: 'Орбітальний кухар', desc: 'Збудуй орбітальну станцію' },
    ru: { name: 'Орбитальный повар', desc: 'Построй орбитальную станцию' },
  },
  a23: {
  ...
  a24: {
    uk: { name: 'Зоряний інженер', desc: 'Збудуй сферу Дайсона' },
    ru: { name: 'Звёздный инженер', desc: 'Построй сферу Дайсона' },
  },
  a25: {
    uk: { name: 'Квантовий пекар', desc: 'Запусти квантовий синтезатор' },
    ru: { name: 'Квантовый пекарь', desc: 'Запусти квантовый синтезатор' },
  },
  a26: {
    uk: { name: 'Вічність смаку', desc: 'Розпали вічний очаг' },
    ru: { name: 'Вечность вкуса', desc: 'Разожги вечный очаг' },
  },
};
...
export const TRANSLATIONS = {
  uk: {
    ...
    statAchievements: 'Досягнень',
    statRareCollection: 'Рідкісні фокачі',
    statEmpire: 'Імперія та подвиги',
    rebirthLevel: 'Ребіртх: {0} рівень',
    rebirthBonus: '+{0}% доходу назавжди • +{1} енергії',
    rebirthReady: '+{0} Готово!',
    rebirthReq: '🔒 Потрібно: 10 000 000 🫓 (10 млн / 10кк)',
    rebirthNext: '🎯 До наступного (+{0})',
    rebirthEarned: 'Зароблено: {0} 🫓',
    rebirthTarget: 'Ціль: {0} 🫓',
    rebirthTipLocked: '💡 Ребіртх відкривається при досягненні <b>10 000 000 фокач</b> (залишилось ще {0}). Він розблокує нові будівлі та прокачки в магазині! 💎 Діаманти та ВІП зберігаються.',
    ...
    rebirthBtnLocked: '🔒 Потрібно 10 000 000 🫓 (ще {0})',
    ...
    tips: [
      ...
      '• 🔄 Ребіртх доступний від 10 000 000 фокач (10 млн / 10кк) — дає +7% доходу назавжди та відкриває нові товари!',
  ...
  ru: {
    ...
    statAchievements: 'Достижений',
    statRareCollection: 'Редкие фокаччи',
    statEmpire: 'Империя и подвиги',
    rebirthLevel: 'Ребиртх: {0} уровень',
    rebirthBonus: '+{0}% дохода навсегда • +{1} энергии',
    rebirthReady: '+{0} Готово!',
    rebirthReq: '🔒 Требуется: 10 000 000 🫓 (10 млн / 10кк)',
    rebirthNext: '🎯 До следующего (+{0})',
    rebirthEarned: 'Заработано: {0} 🫓',
    rebirthTarget: 'Цель: {0} 🫓',
    rebirthTipLocked: '💡 Ребиртх открывается при достижении <b>10 000 000 фокачч</b> (осталось ещё {0}). Он разблокирует новые здания и прокачки в магазине! 💎 Алмазы и ВИП сохраняются.',
    ...
    rebirthBtnLocked: '🔒 Требуется 10 000 000 🫓 (ещё {0})',
    ...
    tips: [
      ...
      '• 🔄 Ребиртх доступен от 10 000 000 фокачч (10 млн / 10кк) — даёт +7% дохода навсегда и открывает новые товары!',
