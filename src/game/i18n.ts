...
export const TRANSLATIONS = {
  uk: {
    ...
    gameVersion: 'ФОКАЧА КЛІКЕР v1.3.4',
    ...
    donateSubtitle: 'Офіційна покупка за Telegram Stars ⭐',
  ...
  ru: {
    ...
    gameVersion: 'ФОКАЧЧА КЛИКЕР v1.3.4',
    ...
    donateSubtitle: 'Официальная покупка за Telegram Stars ⭐',
