...
export const DIAMOND_BUILDINGS_I18N: Record<string, Record<Lang, LocalizedItem>> = {
  d_oven: {
    uk: { name: 'Кристалічна піч', desc: 'Кристалічний жар пече стабільно та гаряче (+2% CPS)' },
    ru: { name: 'Кристальная печь', desc: 'Кристальный жар печёт стабильно и горячо (+2% CPS)' },
  },
  d_mine: {
    uk: { name: 'Діамантова копальня', desc: 'Добуває алмазний пил для надміцного тіста (+3% CPS)' },
    ru: { name: 'Алмазный рудник', desc: 'Добывает алмазную пыль для сверхпрочного теста (+3% CPS)' },
  },
  d_palace: {
    uk: { name: 'Смарагдовий палац', desc: 'Королівська резиденція елітних пекарів (+4% CPS)' },
    ru: { name: 'Изумрудный дворец', desc: 'Королевская резиденция элитных пекарей (+4% CPS)' },
  },
  d_lab: {
    uk: { name: 'Квантова лабораторія', desc: 'Синтез нано-фокач вищої проби (+5% CPS)' },
    ru: { name: 'Квантовая лаборатория', desc: 'Синтез нано-фокачч высшей пробы (+5% CPS)' },
  },
  d_colossus: {
    uk: { name: 'Діамантовий колос', desc: 'Древня статуя бога випічки (+6% CPS)' },
    ru: { name: 'Алмазный колосс', desc: 'Древнее изваяние бога выпечки (+6% CPS)' },
  },
  d_citadel: {
    uk: { name: 'Зоряна цитадель', desc: 'Генерує фокачі з зоряного пилу (+8% CPS)' },
    ru: { name: 'Звёздная цитадель', desc: 'Генерирует фокаччи из звёздной пыли (+8% CPS)' },
  },
};
